...
typedef enum
{
    PORT_UART_ERR_NONE = 0x00U,   // 无错误
    PORT_UART_ERR_ORE  = 0x01U,   // 溢出错误
    PORT_UART_ERR_FE   = 0x02U,   // 帧错误
    PORT_UART_ERR_NE   = 0x04U,   // 噪声错误
    PORT_UART_ERR_PE   = 0x08U,   // 奇偶校验错
} port_uart_error_t;
