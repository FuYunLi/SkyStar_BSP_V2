...
def main():
    ...
    # Check if BSP/Interface group exists
    group_name = "BSP/Interface"
    target_group = None
    ...
    # Define files to add
    files_to_add = [
        {"name": "port_critical.c", "type": "1", "path": "../BSP/Interface/port_critical.c"},
        {"name": "port_critical.h", "type": "5", "path": "../BSP/Interface/port_critical.h"},
    ]
